...
def main():
    ...
    with st.sidebar:
        ...
        uploaded_file = st.file_uploader(
            "📁 Upload Your Data (Excel/CSV)",
            type=['xlsx', 'xls', 'csv'],
            help="Upload historical museum visitor data"
        )
        ...
        if uploaded_file:
            ...
            **This dashboard provides:**
            ...
            st.warning("👆 Upload your Excel/CSV file to start")
            st.markdown("---")
...
• day_of_week
            ...
            | date | museum | visitor_count |
            |------|--------|---------------|
            | 2024-01-01 | Museum A | 1250 |
            | 2024-01-02 | Museum A | 980 |
            """)
    ...
    if uploaded_file:
        ...
        <div style="text-align: center; padding: 3rem; background: white;
            ...
            <h2 style="color: #1e3c72; margin-bottom: 1rem;">
                👋 Welcome to Qatar Museums Forecasting Dashboard
            </h2>
            <p style="font-size: 1.2rem; color: #666; margin-bottom: 2rem;">
                Upload your Excel or CSV file to get started with AI-powered predictions
            </p>
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem; margin-top: 3rem;">
                <div style="padding: 2rem; background: linear-gradient(135deg, #667eea, #764ba2);
                    ...
                    <p>AI-powered forecasts using multiple models</p>
                </div>
                
                <div style="padding: 2rem; background: linear-gradient(135deg, #4facfe, #00f2fe);
                            border-radius: 12px; color: white;">
                    <h3 style="font-size: 2.5rem; margin: 0;">💰</h3>
                    <h4>Revenue Insights</h4>
                    <p>Detailed sales forecasts by category</p>
                </div>
                
                <div style="padding: 2rem; background: linear-gradient(135deg, #f093fb, #f5576c);
                            border-radius: 12px; color: white;">
                    <h3 style="font-size: 2.5rem; margin: 0;">💡</h3>
                    <h4>Actionable Tips</h4>
                    <p>Strategic recommendations for growth</p>
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
